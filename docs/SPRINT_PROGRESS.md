...
- completed sprints: `B1` through `B16`, `C1`, `C2`, `C3`, `C4`, `C5`, `C6`, `C7`, `C8`, `C9`, `C10`, `C11`, `C12`, `D1`, `D2`, `D3`, `D4`, `D5`, `D6`, `D7`, `D8`, `D9`, `D10`, `D11`, `D12`, `D13`, `E1`, `E2`, `E3`, `E4`, `E5`, `F1`, `F2`, `F3`, `F4`, `F5`, `F6`, `F7`, `F8`, `F9`, `G1`, `G2`, `H1`, `H2`, `H3`, `I1`, `I2`, `I3`, `J1`, `J2`, `K1`, `K2`, `L1`, `L2`, `M1`, `M2`, `N1`, `N2`, `O1`, `O2`, `P1`, `P2`, `Q1`, `Q2`, `R1`, `R2`, `S1`, `S2`, `T1`, `T2`, `T3`, `U1`, `U2`, `U3`, `U5`, `U6`, `U7`, `U8`, `U9`, `U10`
- progress:
  ...
  - remote-capable resolution entry track `U10`: `1/1` complete, `100%`
  - currently documented sprint set `B1~B16` + `C1~C12` + `D1~D13` + `E1~E5` + `F1~U10`: `95/95` complete, `100%`
...
- current state:
  ...
  - `Sprint U10` fixed that remote-capable resolution is not mere scheduler relaxation, but an artifact-aware policy step that reads `consume policy + producerNode + replicaNodes/recorded order + observable failure signal`
...
| U10 | Complete | fixed that remote-capable resolution is not mere scheduler relaxation, but an artifact-aware policy step that reads `consume policy + producerNode + replicaNodes/recorded order + observable failure signal` |
...
| Validation | dynamic fallback after explicit placement | High | `U10` fixes the remote-capable resolution input set, and the next step is to decide whether this judgment should be raised into a controller-owned path |
...
The `U4` completion/progress refresh was absorbed into the `U3` close-out turn,
...
- fix the validation question that bridges observable failure signals into actual resubmit judgment

Completion criteria:

- the observable-to-resubmit validation note is fixed in one document
