...
- 완료 스프린트: `B1` ~ `B16`, `C1`, `C2`, `C3`, `C4`, `C5`, `C6`, `C7`, `C8`, `C9`, `C10`, `C11`, `C12`, `D1`, `D2`, `D3`, `D4`, `D5`, `D6`, `D7`, `D8`, `D9`, `D10`, `D11`, `D12`, `D13`, `E1`, `E2`, `E3`, `E4`, `E5`, `F1`, `F2`, `F3`, `F4`, `F5`, `F6`, `F7`, `F8`, `F9`, `G1`, `G2`, `H1`, `H2`, `H3`, `I1`, `I2`, `I3`, `J1`, `J2`, `K1`, `K2`, `L1`, `L2`, `M1`, `M2`, `N1`, `N2`, `O1`, `O2`, `P1`, `P2`, `Q1`, `Q2`, `R1`, `R2`, `S1`, `S2`, `T1`, `T2`, `T3`, `U1`, `U2`, `U3`
- 진행률:
  ...
  - 현재 문서화된 스프린트 전체 `B1~B16` + `C1~C12` + `D1~D13` + `E1~E5` + `F1~U3` 기준: `89/89` 완료, `100%`
...
| 검증 | dynamic DAG placement | 높음 | `U3`에서 parent-result-driven explicit child Job mutation까지는 원격 실검증으로 확보됐지만, remote fallback semantics는 아직 열려 있음 |
| 구현 | dynamic fallback after explicit placement | 높음 | 다음은 same-node preferred 이후 remote fallback을 어떤 구조로 연결할지 validation entry가 필요 |
...
`U4`에 해당하는 completion/progress refresh는 이번 `U3` 종료 턴에서 같이 닫았다.
그래서 다음 직접 후속은 fallback 쪽으로 넘어가는 것이 맞다.

### U5 - Dynamic Fallback Validation Entry

목표:

- explicit placement mutation 이후 same-node preferred / remote fallback 질문을 다음 직접 validation entry로 고정

완료 기준:

- fallback question이 하나의 entry note로 좁게 고정됨

### U6 - Same-Node Required vs Preferred Validation

목표:

- explicit `nodeSelector`를 required로 둘지, preferred placement로 바꿔야 할지 실제 validation 기준을 정함

완료 기준:

- same-node required / preferred 판단 기준이 문서로 고정됨
