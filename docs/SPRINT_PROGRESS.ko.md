...
- 완료 스프린트: `B1` ~ `B16`, `C1`, `C2`, `C3`, `C4`, `C5`, `C6`, `C7`, `C8`, `C9`, `C10`, `C11`, `C12`, `D1`, `D2`, `D3`, `D4`, `D5`, `D6`, `D7`, `D8`, `D9`, `D10`, `D11`, `D12`, `D13`, `E1`, `E2`, `E3`, `E4`, `E5`, `F1`, `F2`, `F3`, `F4`, `F5`, `F6`, `F7`, `F8`, `F9`, `G1`, `G2`, `H1`, `H2`, `H3`, `I1`, `I2`, `I3`, `J1`, `J2`, `K1`, `K2`, `L1`, `L2`, `M1`, `M2`, `N1`, `N2`, `O1`, `O2`, `P1`, `P2`, `Q1`, `Q2`, `R1`, `R2`, `S1`, `S2`, `T1`, `T2`, `T3`, `U1`, `U2`, `U3`, `U5`, `U6`, `U7`
- 진행률:
  ...
  - 현재 문서화된 스프린트 전체 `B1~B16` + `C1~C12` + `D1~D13` + `E1~E5` + `F1~U7` 기준: `92/92` 완료, `100%`
...
| 검증 | dynamic fallback after explicit placement | 높음 | `U7`에서 1순위 trigger 후보를 `PodScheduled=False, Unschedulable`로 좁혔고, 다음은 required를 preferred 또는 remote path로 어떻게 낮출지 정해야 함 |
...
- current required locality path를 어떤 조건에서 preferred locality 또는 remote-capable path로 낮출지 entry를 고정

완료 기준:

- downgrade 조건이 entry note로 고정됨

### U9 - K8s Observable Integration Validation

목표:

- `K8sObserver.ObservePod()` / `ObserveWorkload()`를 current fallback 판단 경로에 어떻게 연결할지 validation question을 고정
